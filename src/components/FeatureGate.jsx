...
export default function FeatureGate({
  ...
  anyOf,            // string[] — gate passes if ANY listed feature is enabled
  children,
  // NEW props:
  ...
  // ── Any-of feature gate — passes if ANY listed feature is enabled ────────────
  if (Array.isArray(anyOf) && anyOf.length && !anyOf.some((k) => hasFeature(k))) {
    return (
