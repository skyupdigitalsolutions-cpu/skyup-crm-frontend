...
function mapLead(l) {
  ...
  // Sort descending once — used for lastCall everywhere
  ...
  return {
    ...
    // Last call fields — derived once here, used everywhere
...
export default function AdminLeadsPage() {
  ...
  const exportToCSV = useCallback(() => {
    ...
    const headers = [
      ...
      "Date", "Status", "Quality", "Calls", "Last Outcome", "Last Called", "Remark",
    ];
    ...
    const rows = displayed.map(l => [
      ...
      l.lastOutcome || "",
      l.lastCalledAt ? new Date(l.lastCalledAt).toLocaleDateString("en-GB") : "",
      l.remark,
    ].map(escape).join(","));
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          ...
          <p className="text-[13px] text-[#8B92A9] dark:text-[#565C75] mt-0.5">
            Full pipeline view — click any lead to see its complete journey with remarks & dates
          </p>
        </div>
                ...
                <thead>
                  <tr className="bg-[#F8F9FC] dark:bg-[#13161E] border-b border-[#E4E7EF] dark:border-[#262A38]">
                    {["Lead", "Contact", "Agent", "Source / Campaign", "Date", "Status", "Quality", "Last Outcome", ""].map(h => (
                      <th key={h} className="px-4 py-3 text-left text-[10px] font-bold text-[#8B92A9] dark:text-[#565C75] uppercase tracking-widest whitespace-nowrap">
                        {h}
                      </th>
                    ))}
                  </tr>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          ...
                          {l.email && (
                            <p className="text-[10px] text-[#8B92A9] truncate max-w-[130px]">{l.email}</p>
                          )}
                        </td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[#0F1117] dark:text-[#F0F2FA] truncate max-w-[90px]">
                              {l.agent || "Unassigned"}
                            </span>
                          </div>
                          {l.reassignCount > 0 && (
                        ...
                        {/* Last Call Outcome — correct logic using pre-computed fields */}
                        <td className="px-4 py-3">
                          {l.lastOutcome ? (
                            <div>
                              ...
                              {l.lastRemark && (
                                <p className="text-[9px] text-[#8B92A9] truncate max-w-[140px] italic mt-0.5">
                                  "{l.lastRemark}"
                                </p>
                              )}
                            </div>
                            ...
                            <div>
                              ...
                              {l.callHistory.length === 0 && (
                                <p className="text-[9px] text-[#C4C9D9] dark:text-[#3E4257] mt-0.5">0 calls logged</p>
                              )}
                            </div>
                          )}
                        </td>
                      ...
                      <button
                        ...
                        className={`w-7 h-7 rounded-lg text-[11px] font-semibold transition ${
                          page === n
                            ...
                            : "border border-[#E4E7EF] dark:border-[#262A38] text-[#8B92A9] hover:bg-white dark:hover:bg-[#1A1D27]"
                        }`}
                      >
                        {n}
                      </button>
