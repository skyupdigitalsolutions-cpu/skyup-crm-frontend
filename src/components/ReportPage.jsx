        ...
        <div className="flex items-center gap-2">
          ...
          {(role === "admin" || role === "superadmin") && (
            <>
              ...
              <button onClick={() => importInputRef.current?.click()} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#7C3AED] text-white text-[13px] font-semibold hover:bg-violet-700 transition">
